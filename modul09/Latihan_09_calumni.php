...
//cek apakah $uploadOk sudah diset menjadi 0 oleh error if($uploadOk==0){
...
$sql = "INSERT INTO alumni(nama, tahun_lulus,
 
jurusan, foto) VALUES ('$nama', '$tahun_lulus', '$jurusan', '$target_file')";
